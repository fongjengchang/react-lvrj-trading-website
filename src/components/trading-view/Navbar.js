    ...
    <div>
      <div className={`mobile-toggle-panel ${isShow ? 'show' : 'hide'}`}>
        <div className="toggle-button-group">
          {isShow ? (
            <FaAngleRight className="toggle-arrow" onClick={() => setIsShow(!isShow)} />
          ) : (
            <FaAngleLeft className="toggle-arrow" onClick={() => setIsShow(!isShow)} />
          )}
      ...
      <div className={`navbar ${mode ? 'dark' : 'light'}`}>
        ...
        <div className="navbar-left">
          ...
          <div className="navbar-menu">
            <a className="menu-link" href="/decentralized-trading/">
              Platform
            </a>
            <a className="menu-link" href="/decentralized-trading/">
              Practice
        ...
        <ul className="menu-btns">
          ...
          <li>
            <a className="button btn-pink" href="/decentralized-trading/">
              Buy $LVRJ" <FaExchangeAlt className="reg-circle-icon" />
            </a>
          </li>
          <li>
            <a className="button btn-pink" href="/decentralized-trading/">
              Connect Wallet <FaPowerOff className="reg-circle-icon" />
            </a>
          </li>
        </ul>
