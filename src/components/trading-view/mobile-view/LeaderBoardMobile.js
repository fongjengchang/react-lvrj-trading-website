      ...
      <div className="top-rated-section">
        <div className="rated-1">
          ...
          {showTip === 1 && (
            <div className="detailed-info-top-3">
              <div>
                TRADES: <strong> 4 </strong>
              </div>
              <div>
                WINRATE: <strong> 100% </strong>
              </div>
        ...
        <div className="rated-2">
          ...
          {showTip === 2 && (
            <div className="detailed-info-top-3">
              <div>
                TRADES: <strong> 12 </strong>
              </div>
              <div>
                WINRATE: <strong> 94.1% </strong>
              </div>
              <span role="img" aria-label="Fire">
                🔥 WIN STREAK: 8
              </span>
        ...
        <div className="rated-3">
          ...
          {showTip === 3 && (
            <div className="detailed-info-top-3">
              <div>
                TRADES: <strong> 31 </strong>
              </div>
              <div>
                WINRATE: <strong> 71.1% </strong>
              </div>
              <span role="img" aria-label="Fire">
                🔥 WIN STREAK: 6
              </span>
          ...
          <div className="list-item" key={index}>
            <div className="list-row" onClick={() => handleExpandItem(index)}>
              ...
              <div style={{ textAlign: 'right' }}>
                <span className={`${item.pnl > 0 ? 'pnl-color' : 'fall-color'}`}>
                  {item.pnl > 0 ? '+' : ''}
                  {item.pnl}%
                </span>
              </div>
            ...
            {item.expanded && (
              <div className="detailed-info">
                <span>
                  TRADES: <strong>{item.trades}</strong>
                </span>
                <span>
