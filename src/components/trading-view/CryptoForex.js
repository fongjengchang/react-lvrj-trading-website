  ...
  return (
    <div className="crypto-forex-panel">
      ...
      <Tabs className="search-result-box">
        ...
        <TabPanel>
          {isLoading ? (
            <ReactLoading type="bubbles" className="loading-style" color="grey" height="470px" width="20%" />
          ) : (
            <div>
              ...
              <div className="table-content">
                {filteredData.map((item, index) => (
                  <div className="table-row" key={index}>
                    ...
                    <span className={item.price < 131.0 ? 'fall-color' : 'search-rising-color'}>{item.price}</span>
